...
;; Caplan et al. (2015) sentences
(setf *c15a*      "the girl hugged the boy *")
(setf *c15p*      "the boy was hugged by the girl *")
(setf *c153np*    "the woman said that the girl hugged the boy *")
(setf *c15pron*   "the woman said that the girl hugged her *")
(setf *c15refl*   "the woman said that the girl hugged herself *")
(setf *c15scl*    "it was the girl who hugged the boy *")
(setf *c15ocl*    "it was the boy who the girl hugged *")
(setf *c15sr*     "the girl who hugged the boy washed the woman *stop*")
(setf *c15or*     "the boy who the girl hugged washed the woman *stop*")
(setf *c15orrefl* "the woman who the girl hugged washed herself *stop*")
(setf *c15srrefl* "the woman who hugged the girl washed herself *stop*")
(setf *c15orpron* "the woman who the girl hugged washed her *stop*")
(setf *c15srpron* "the woman who hugged the girl washed her *stop*")
...
(define-experiment CAPLAN15-SRREFL
  :full-name "Caplan et al. (2015) SR with reflexive pronoun"
  :conditions
  ((c15-sr-refl  *c15srrefl*
        (EMB-V  :position 4)
        (REFL   :position 8)
        )
   )
...
(define-experiment CAPLAN15-ORREFL
  :full-name "Caplan et al. (2015) OR with reflexive pronoun"
  :conditions
  ((c15-or-refl  *c15orrefl*
        (EMB-V  :position 6)
        (REFL   :position 8)
        )
   )
...
(define-experiment CAPLAN15-SRPRON
  :full-name "Caplan et al. (2015) SR with pronoun"
  :conditions
  ((c15-sr-pron  *c15srpron*
        (EMB-V  :position 4)
        (REFL   :position 8)
        )
   )
...
(define-experiment CAPLAN15-ORPRON
  :full-name "Caplan et al. (2015) OR with pronoun"
  :conditions
  ((c15-or-pron  *c15orpron*
        (EMB-V  :position 6)
        (REFL   :position 8)
        )
   )
...
(define-experiment CAPLAN15-SOREFL
  :full-name "Caplan et al. (2015) OR/SR with reflexive pronoun"
  :conditions
  ((c15-sr-refl  *c15srrefl*
        (EMB-V  :position 4)
        (REFL   :position 8)
...
(define-experiment CAPLAN15-SOPRON
  :full-name "Caplan et al. (2015) OR/SR with pronoun"
  :conditions
  ((c15-sr-pron   *c15srpron*
        (EMB-V  :position 4)
        (PRON   :position 8)
...
(define-experiment CAPLAN15-FULL-REL
  :full-name "Caplan et al. (2015) OR/SR, OR/SR-REFL & OR/SR-PRON"
  :conditions
  (
   (c15-sr        *c15sr*
              (NP1  :position (1 2))
...
(define-experiment CAPLAN15-FULL
  :full-name "Caplan et al. (2015) OR/SR, OR/SR-REFL & OR/SR-PRON"
  :conditions
  (
   (c15-a         *c15a*
