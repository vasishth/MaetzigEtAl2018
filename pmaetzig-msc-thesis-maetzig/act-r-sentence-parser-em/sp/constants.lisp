...
(chunk-type syn-obj
    ...
    (main-subject       nil)   ;; [pmaetzig 2017-05-21] added for pronoun processing; is nil per default, main subject of a clause receives this feature
    unattached
    (in-clause C0)
    (location nil)
    ; comp-word
...
;  (ip-gapped-goal isa chunk)
  ...
  (P isa chunk)
  (C isa chunk)
  (PN-R isa chunk)  ;; added 2017-04-22 [pmaetzig]
  (PN isa chunk)    ;; added 2017-05-12 [pmaetzig]
  (DET isa chunk)
  (ADV isa chunk)
  (ADJ isa chunk)
...
(set-similarities
   ...
   (none N -0.99)
   (none PN-R -0.99)  ;; added 2017-04-24 pmaetzig
   (none PN -0.99)    ;; added 2017-05-12 pmaetzig
   (none V -0.99)
   (none Adj -0.99)
   (none P -0.99)
   (none C -0.99)
