...
;; Add-on: Maetzig et al. (2017) simulations of Caplan et al. (2015)
(verb washed :id washed-v)
(verb hugged :id hugged-v)

(noun woman :id woman-n :gender fem)
(noun men :id men-n :cat n :gender masc :number plural)
(noun her :id her-n :cat PN :gender fem :number singular :case acc)
(noun herself :id herself-n :cat PN-R :gender fem :number singular :case acc)
