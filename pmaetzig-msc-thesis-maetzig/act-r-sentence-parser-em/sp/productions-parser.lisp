...
;; [pmaetzig]   When goal is DP and reflexive pronoun is read

(P set-retrieval-cues-goal-DP-input-PN-R
   =goal>
      ISA             comprehend-sentence
      state           "lexical-retrieval"
      goal-cat        DP-goal
...
(P set-retrieval-cues-goal-DP-input-PN
   =goal>
      ISA             comprehend-sentence
      state           "lexical-retrieval"
      goal-cat        DP-goal
...
;; [pmaetzig]     if waiting for DP and pronoun DP is retrieved, attach it as object of the verb

(P attach-DP-PN-R-as-object
   =goal>
      ISA               comprehend-sentence
      state             "wm-retrieval"
   =grammatical>
...
==>
   ...
   =goal>  ;; the goal buffer stays the same, because another DP has to be retrieved
   +DPb>
      isa               syn-obj
      cat               DP
      subcat            reflexive
      ...
      next-goal         =next-goal
      head-word         =head-word
    !bind! =new-number (map-lex-to-syn =number)
    !bind! =new-gender (map-lex-to-syn =gender)
...
==>
   ...
   +DPb>
      ...
      waiting-for-case  nil
      waiting-for-cat   nil
      next-goal         =next-goal  ;;[pmaetzig] 2017-05-12: necessary?
      head-word         =head-word
    !bind! =new-number (map-lex-to-syn =number)
    !bind! =new-gender (map-lex-to-syn =gender)
...
;; [pmaetzig]     refl. pronoun DP is coindexed with the antecedent found
;;
(P retrieve-reflexive-antecedent
   =goal>
      ISA               comprehend-sentence
      state             "wm-retrieval"
   =grammatical>
...
==>
   ...
   +grammatical>
      ...
      number            =number
      gender            =gender
      ;head-word         =antecedent-word
)

(P finish-reflexive-retrieval
  =goal>
    isa                 comprehend-sentence
    state               "wm-retrieval"
  =grammatical>
...
;   !bind! =goal-cat (map-goal-category =next-goal)
   ...
   !eval! (attach-message =head-word "antecedent" =antecedent-word)
   !eval! (set-end-time)
   !eval! (increase-ref-count-parseloc)
)

(P retrieve-pronominal-antecedent
   =goal>
      ISA               comprehend-sentence
      state             "wm-retrieval"
   =grammatical>
